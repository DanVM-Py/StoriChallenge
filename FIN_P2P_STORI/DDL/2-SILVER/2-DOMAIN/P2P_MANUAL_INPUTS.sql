CREATE OR REPLACE TABLE STORI_SILVER_DB_PROD.PROCUREMENT_TO_PAY.DOMAIN_INVOICE_ADJUSTMENTS (
...
COMMENT = 
  'THIS TABLE STORES MANUAL ADJUSTMENTS MADE TO INVOICES OR PURCHASE ORDERS. 
...
CLUSTER BY (SUPPLIER_ID, ADJUSTMENT_DATE)
;