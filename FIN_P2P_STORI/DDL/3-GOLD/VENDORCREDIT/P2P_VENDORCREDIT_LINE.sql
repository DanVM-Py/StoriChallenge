CREATE OR REPLACE SEQUENCE STORI_GOLD_DB_PROD.PROCUREMENT_TO_PAY.SEQUENCE_VENDORCREDIT_LINE START = 1 INCREMENT = 1 ORDER;

CREATE OR REPLACE TABLE STORI_GOLD_DB_PROD.PROCUREMENT_TO_PAY.VENDORCREDIT_LINE (
  ID INT NOT NULL DEFAULT STORI_GOLD_DB_PROD.PROCUREMENT_TO_PAY.SEQUENCE_VENDORCREDIT_LINE UNIQUE PRIMARY KEY
  , ITEM_ID INT PRIMARY KEY COMMENT 'UNIQUE IDENTIFIER FOR THE ITEM'
