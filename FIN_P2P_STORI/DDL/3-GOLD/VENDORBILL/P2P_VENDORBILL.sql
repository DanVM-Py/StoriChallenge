CREATE OR REPLACE SEQUENCE STORI_GOLD_DB_PROD.PROCUREMENT_TO_PAY.SEQUENCE_VENDORBILL START = 1 INCREMENT = 1 ORDER;

CREATE OR REPLACE TABLE STORI_GOLD_DB_PROD.PROCUREMENT_TO_PAY.VENDORBILL (
  ID INT NOT NULL DEFAULT STORI_GOLD_DB_PROD.PROCUREMENT_TO_PAY.SEQUENCE_VENDORBILL UNIQUE PRIMARY KEY
